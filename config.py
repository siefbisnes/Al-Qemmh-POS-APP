...
CHANGELOG = [
    {
        ...
        "date": "2026-09-11",
        "patches": [
            "إزالة اختبار الأجهزة وجميع مداخل الوصول إليه من التطبيق.",
            "إصلاح تشغيل أزرار البيع والتقارير عند فتح الصفحات دون الحاجة إلى تحديث الصفحة.",
            "دمج قيمة المنتجات داخل رسم المشتريات والعائد المتوقع.",
            "السماح لحساب المستخدم بتعديل الدرج والأونلاين فقط Setup تلقائيًا بعد إنشاء ملف EXE والتحقق من نجاحه.",
        ],
        "notes": [],
        "user_must_do": [],
    },
    ...
    },
    {
        ...
        "notes": [],
        "user_must_do": [
            "يُوصى بالنقر على (تصحيح المشكلات) مع كل تحديث، وبشكل دوري كل فترة أو كل 6 أشهر.",
        ],
    },
]
